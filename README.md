...
[![OpenAPI](https://img.shields.io/badge/OpenAPI-Swagger-85EA2D?logo=swagger&logoColor=black)](https://kriakiku.github.io/potato-network/docs/api/#openapi)
...
`GET /` on the API port always redirects to the OpenAPI docs (`https://kriakiku.github.io/potato-network/docs/api/#openapi`).
...
- OpenAPI (ReDoc): https://kriakiku.github.io/potato-network/docs/api/#openapi
